...
const WebSocketTest: React.FC = () => {
    ...
    const { sendMessage, messages, readyState, connectionStatus, clearMessages } = useWebSocketManager();
        ...
        <div className="min-h-screen flex flex-col items-center justify-center bg-gray-100 p-6">
            <div className="w-full max-w-md bg-white shadow-lg rounded-lg p-6">
                ...
                <div className="flex space-x-2 mb-4">
                    ...
                    <button
                        onClick={handleSendJsonMessage}
                        className="bg-green-500 text-white px-4 py-2 rounded hover:bg-green-600 disabled:bg-gray-40"
                        disabled={readyState !== ReadyState.OPEN}
                    >
                        Send JSON
                    </button>
