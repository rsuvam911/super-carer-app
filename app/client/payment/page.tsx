...
import { ChevronLeft, ChevronRight, CreditCard, Download, Filter, Search, Plus } from "lucide-react"
import { useState } from "react"
import { useAuth } from "@/lib/auth-context"
import { StripePaymentMethods } from "@/components/stripe-payment-method"
      ...
      <div className="bg-white rounded-lg shadow-sm overflow-hidden">
        <div className="flex border-b border-gray-200">
          <button
            ...
            className={`px-6 py-4 text-sm font-medium ${activeTab === "transactions"
          ...
          <button
            ...
            className={`px-6 py-4 text-sm font-medium ${activeTab === "payment-methods"
              ? "text-[#00C2CB] border-b-2 border-[#00C2CB]"
              : "text-gray-500 hover:text-gray-700"
              }`}
          >
      ...
      {isClient ? (
        <div className="mb-6">
          <PaymentMethodsList
            ...
            onPaymentMethodsChange={(count) => {
              // Handle payment methods count change if needed
            }}
          />
        </div>
      ) : (
